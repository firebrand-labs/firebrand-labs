...
const AboutSection: React.FC<SectionProps> = ({ isActive }) => {
  ...
  return (
    <section
      ref={ref}
      className="flex items-center justify-center flex-col w-screen overflow-x-hidden bg-background bg-[image:var(--color-repeating-gradient)] md:min-h-svh py-16  snap-start"
    >
...
const WhatWeDoSection: React.FC<SectionProps> = ({ isActive }) => {
  ...
  return (
    <section
      ref={ref}
      className="flex items-center justify-center relative flex-col w-screen overflow-x-hidden bg-background bg-[image:var(--color-repeating-gradient)] min-h-svh md:min-h-svh snap-start"
    >
...
const TeamSection: React.FC<SectionProps> = ({ isActive }) => {
  ...
  return (
    <section
      ref={ref}
      className="flex items-center justify-center flex-col w-screen overflow-x-hidden relative bg-background bg-[image:var(--color-repeating-gradient)] py-16 md:py-0 md:min-h-svh snap-start "
    >
      <div className="container flex items-center justify-center ">
...
const BlogSection: React.FC<SectionProps> = ({ isActive }) => {
  ...
  return (
    <section
      ref={ref}
      className="flex items-center justify-center flex-col w-screen overflow-x-hidden relative bg-background bg-[image:var(--color-repeating-gradient)] md:min-h-svh py-16 snap-start "
    >
...
const FooterSection: React.FC<SectionProps> = ({ isActive }) => {
  ...
  return (
    <Footer
      ref={ref}
      className="bg-[image:initial] bg-yellow-level-four snap-start"
    />
  );
};

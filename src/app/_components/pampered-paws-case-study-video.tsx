...
interface PamperedPawsCaseStudyVideoProps {}

const PamperedPawsCaseStudyVideo: FC<PamperedPawsCaseStudyVideoProps> = () => {
    ...
    <section className="w-full relative flex items-center justify-center">
      <div className="container flex items-center justify-start ">
        <div
          id="youtube-id"
          className={cn(
            "w-full rounded-2xl overflow-hidden shadow-sm 2xl:scale-90 3xl:scale-100 relative max-w-2xl object-cover",
        ...
        <div
          className={cn(
            "flex flex-row absolute items-center justify-center z-20 left-[15%] 2xl:left-[20%] gap-4 bottom-[15%]",
...
export default PamperedPawsCaseStudyVideo;

    ...
    <ul className="w-full grid grid-cols-1 md:grid-cols-3 items-start justify-center gap-5 3xl:mt-12">
      {allOurBlogs.length ? (
        allOurBlogs.map((item, i) => (
          ...
          >
            <Link
              className="flex items-center flex-col justify-center gap-2 relative"
            ...
            >
              ...
              <span className=" mb-2 lowercase bg-background/60 px-2.5 py-1 rounded-full text-[14px] text-foreground font-light font-paragraph leading-normal tracking-normal">
                {item.category}
              </span>
